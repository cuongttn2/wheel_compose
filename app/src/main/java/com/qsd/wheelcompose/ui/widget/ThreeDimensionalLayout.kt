...
import androidx.compose.ui.unit.dp
import com.qsd.wheelcompose.ui.theme.three_dimensional_edge_default
...
fun ThreeDimensionalLayout(
    perspective: Perspective = Perspective.Left(
        bottomEdgeColor = three_dimensional_edge_default,
        rightEdgeColor = three_dimensional_edge_default
    ),
    onClick: () -> Unit? = {},
